...
namespace ToDoListApp.Controllers
{
    ...
    public class ToDoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Description,IsCompleted")] ToDo toDo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Description,IsCompleted")] ToDo toDo)
        {
            if (ModelState.IsValid)
            {
